                ...
                SystemItems = new List<SystemItem>
                {
                    ...
                    new SystemItem { System = "DIMPS", Title = "DIMPS", Url = "https://dimps.optusnet.com.au/search.html", 
                        Searches = new List<SearchItem>
                        {
                            ...
                            new SearchItem{SearchURL = "https://dimps.optusnet.com.au/search/servno?servno=", SearchData = "DN|0$1$2$3"},
                     ...
                     new SystemItem { System = "Nexus", Title = "Nexus", Url = "http://nexus.optus.com.au", 
                        Searches = new List<SearchItem>
                        {
                            new SearchItem{SearchURL = "http://nexus.optus.com.au/index.php?#service/", SearchData = "DN|0$1$2$3"},
                            new SearchItem{SearchURL = "http://nexus.optus.com.au/index.php?#account/", SearchData = "ICON,CMBS|3$1${2}0$3"},
                            new SearchItem{SearchURL = "http://nexus.optus.com.au/index.php?#service/", SearchData = "Mobile|0$1$2"},
                        }},
                    ...
                    new SystemItem { System = "NSI", Title = "NSI", Url = "https://staff.optusnet.com.au/tools/nsi/", 
                        Searches = new List<SearchItem>
                        {
                            new SearchItem{SearchURL = "https://staff.optusnet.com.au/tools/nsi/avc_detail.html?gsid=", SearchData = "Service.PRI|$2"},
